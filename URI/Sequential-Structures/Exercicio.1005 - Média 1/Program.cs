/*
    ...
    SAÍDA: Imprima a mensagem "MEDIA" e a média do aluno conforme exemplo abaixo, com 5 dígitos após o ponto decimal e com um espaço em 
...
namespace URI_1005
{
    class Program
    {
        ...
        {
            double A, B, media; // A e B = nota 1 e nota 2 respectivamente

            A = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);
            B = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);

            media = ((A * 3.5) + (B * 7.5)) / 11; // 3.5 e 7.5 e o pesado de cada materia que totaliza 11
